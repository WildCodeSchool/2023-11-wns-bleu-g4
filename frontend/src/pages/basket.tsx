                                ...
                                <Flex align="center" justifyContent="space-between">
                                    ...
                                    >
                                        <Flex flexDirection="column">
                                            {product &&
                                                <Text>{t("Product :")} {product.name}</Text>}
                                            {selectedSize && <Text>{("Size :")} {selectedSize}</Text>}
                                            {agency && <Text>{t("Agency :")} {agency.name}</Text>}
                                        </Flex>
                                        <Flex>
                                            {quantity && <Text textAlign="center">{t("Quantity :")} {quantity}</Text>}
                                        </Flex>
                                        <Flex>
                                            <Flex flexDirection="column">
                                                {startDate &&
                                                ...
                                                {endDate && <Text>{t("End :")} {new Date(endDate).toLocaleDateString()}</Text>}
                                            </Flex>
                                        </Flex>
                                        <Flex>
                                            {totalPrice && <Text textAlign="center">
