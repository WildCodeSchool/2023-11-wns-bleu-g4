...
export type GetAllBookingQuery = {
  __typename?: "Query";
  getAllBooking: Array<{
    __typename?: "Booking";
    id: number;
 ...
 * });
 */
export function useGetAllBookingQuery(
  baseOptions?: Apollo.QueryHookOptions<GetAllBookingQuery, GetAllBookingQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllBookingQuery, GetAllBookingQueryVariables>(GetAllBookingDocument, options);
}
export function useGetAllBookingLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAllBookingQuery, GetAllBookingQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAllBookingQuery, GetAllBookingQueryVariables>(GetAllBookingDocument, options);
}
export function useGetAllBookingSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllBookingQuery, GetAllBookingQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
