...
export type GetAllParentCategoryQuery = {
  __typename?: "Query";
  getAllParentCategories: Array<{
 ...
 * });
 */
export function useGetAllParentCategoryQuery(
  baseOptions?: Apollo.QueryHookOptions<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>(
    GetAllParentCategoryDocument,
    options,
  );
}
export function useGetAllParentCategoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>(
    GetAllParentCategoryDocument,
    options,
  );
}
export function useGetAllParentCategorySuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetAllParentCategoryQuery, GetAllParentCategoryQueryVariables>(
    GetAllParentCategoryDocument,
    options,
  );
}
...
export type GetAllParentCategoryQueryResult = Apollo.QueryResult<
  GetAllParentCategoryQuery,
  GetAllParentCategoryQueryVariables
>;
