...
export default function OrderDetailsTable({ bookingItems }: { bookingItems: BookingItem[] | undefined }) {
    ...
    return (
        <td colSpan={7} className="p-4 align-top border-y border-gray-200 dark:border-gray-600">
            ...
            <table className="w-full min-w-full">
                ...
                <tbody className="text-sm">
                    {bookingItems?.map((bookingItem: BookingItem) => (
                        <tr key={bookingItem.id} className="border-y border-t-gray-200 dark:border-gray-600 border-b-0">
