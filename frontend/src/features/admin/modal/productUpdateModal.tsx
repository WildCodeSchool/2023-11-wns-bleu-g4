                ...
                <ModalBody pb={6}>
                    <FormControl>
                        <Flex justifyContent="space-between" gap={2} mb={4}>
                            <Box>
                                <FormLabel mb={1} id="name">Name</FormLabel>
                                <Input type="text" placeholder="Name" defaultValue={product.name} />
                            </Box>
                            <Box>
                                <FormLabel mb={1} id="brand">Brand</FormLabel>
                        ...
                        <Flex justifyContent="space-between" gap={2} mb={4}>
                            <Box w="100%">
                                <FormLabel mb={1} id="price">Price</FormLabel>
                            ...
                            <Box w="100%">
                                <Text mb={1} id="category">Category</Text>
                        ...
                        <FormLabel mb={1} id="countInStock">Thumbnail</FormLabel>
